...
const navigation = [
  { name: 'Tổng quan', href: '/', icon: HomeIcon, current: true },
  { name: 'Phân tích', href: '/analytics', icon: ChartBarIcon, current: false },
  { name: 'Cài đặt', href: '/settings', icon: CogIcon, current: false },
];
        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <span className="text-xl font-bold text-primary-600">Bybit Trader</span>
            </div>
